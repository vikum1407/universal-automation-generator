...
-- CreateIndex
CREATE INDEX "Transition_projectId_idx" ON "Transition"("projectId");

-- CreateIndex
CREATE INDEX "Transition_fromId_idx" ON "Transition"("fromId");

-- CreateIndex
CREATE INDEX "Transition_toId_idx" ON "Transition"("toId");
...
-- AddForeignKey
ALTER TABLE "Transition" ADD CONSTRAINT "Transition_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Transition" ADD CONSTRAINT "Transition_fromId_fkey" FOREIGN KEY ("fromId") REFERENCES "Page"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Transition" ADD CONSTRAINT "Transition_toId_fkey" FOREIGN KEY ("toId") REFERENCES "Page"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
