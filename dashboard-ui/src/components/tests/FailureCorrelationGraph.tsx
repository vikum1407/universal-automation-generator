...
export function FailureCorrelationGraph({ edges }: { edges: FailureCorrelationEdge[] }) {
  ...
  return (
    <section>
      <h2 className="text-xl font-semibold mb-2">Failure Correlation Graph</h2>
      ...
      <div className="relative h-64 border rounded bg-white">
        ...
        {edges.map((e, i) => {
          const s = nodes.indexOf(e.source);
          const t = nodes.indexOf(e.target);
