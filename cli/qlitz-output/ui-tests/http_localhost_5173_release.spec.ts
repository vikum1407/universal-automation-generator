...
test('User can navigate using link "Journeys"', async ({ page }) => {
  await page.goto('http://localhost:5173/release');
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/journeys', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/clusters', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/insights', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/analytics', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/graph', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/execution', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/execution/trends', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/execution/insights', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/release', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/release/heatmap', async ({ page }) => {
...
test('Navigate from http://localhost:5173/release to http://localhost:5173/release/story', async ({ page }) => {
...
test('State invariants for http://localhost:5173/release', async ({ page }) => {
