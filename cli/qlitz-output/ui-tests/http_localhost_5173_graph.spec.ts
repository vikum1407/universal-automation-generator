...
test('User can click "✦ Explain"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Explain")', 'button:has-text("✦ Explain")');
...
test('User can click "✦ Recommend"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Recommend")', 'button:has-text("✦ Recommend")');
...
test('User can select an option using "Journey A"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.selectOption('select:has-text("Journey A")', { index: 1 });
  await aiAssertComponentPresence(page, 'select');
  await capturePageBaseline(page);
});


test('User can select an option using "Journey B"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.selectOption('select:has-text("Journey B")', { index: 1 });
  await aiAssertComponentPresence(page, 'select');
  await capturePageBaseline(page);
});


test('User can click "⇄ Compare"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("⇄ Compare")', 'button:has-text("⇄ Compare")');
...
test('User can select an option using "Select Cluster"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.selectOption('select:has-text("Select Cluster")', { index: 1 });
  await aiAssertComponentPresence(page, 'select');
  await capturePageBaseline(page);
});


test('User can click "✦ Analyze Cluster"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Analyze Cluster")', 'button:has-text("✦ Analyze Cluster")');
...
test('User can click "✦ Evolution"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Evolution")', 'button:has-text("✦ Evolution")');
...
test('User can select an option using "Heatmap: NoneChange IntensityRisk VolatilityCluster DriftTransition Fluctuation"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.selectOption('select:has-text("Heatmap: NoneChange IntensityRisk VolatilityCluster DriftTransition Fluctuation")', { index: 1 });
  await aiAssertComponentPresence(page, 'select');
  await capturePageBaseline(page);
});


test('User can click "✦ Story Mode"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Story Mode")', 'button:has-text("✦ Story Mode")');
...
test('User can click "✦ Release Diff"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Release Diff")', 'button:has-text("✦ Release Diff")');
...
test('User can click "✦ Detect Anomalies"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("✦ Detect Anomalies")', 'button:has-text("✦ Detect Anomalies")');
...
test('User can click "Heal Transitions"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("Heal Transitions")', 'button:has-text("Heal Transitions")');
...
test('User can click "▶ Play"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("▶ Play")', 'button:has-text("▶ Play")');
...
test('User can click "❚❚ Pause"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("❚❚ Pause")', 'button:has-text("❚❚ Pause")');
...
test('User can click "► Resume"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("► Resume")', 'button:has-text("► Resume")');
...
test('User can click "↺ Restart"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
...
await selfHealClick(page, 'button:has-text("↺ Restart")', 'button:has-text("↺ Restart")');
...
test('User can select an option using "0.5×1×1.5×2×3×"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.selectOption('select:has-text("0.5×1×1.5×2×3×")', { index: 1 });
  await aiAssertComponentPresence(page, 'select');
  await capturePageBaseline(page);
});


test('User can type into "input[type="range"]"', async ({ page }) => {
  await page.goto('http://localhost:5173/graph');
  await page.fill('input[type="range"]', 'test-value');
  await aiAssertComponentPresence(page, 'input');
  await capturePageBaseline(page);
});


test('Navigate from http://localhost:5173/graph to http://localhost:5173/journeys', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/clusters', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/insights', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/analytics', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/graph', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/execution', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/execution/trends', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/execution/insights', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/release', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/release/heatmap', async ({ page }) => {
...
test('Navigate from http://localhost:5173/graph to http://localhost:5173/release/story', async ({ page }) => {
...
test('State invariants for http://localhost:5173/graph', async ({ page }) => {
